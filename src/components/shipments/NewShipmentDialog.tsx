...
export function NewShipmentDialog({ open, onOpenChange, onShipmentAdded }: NewShipmentDialogProps) {
  ...
  const onSubmit = async (values: z.infer<typeof shipmentFormSchema>) => {
    ...
    try {
      // Notice we're NOT including shipment_id since it will be generated by the database trigger
      ...
      // Use .insert() with { returning: 'minimal' } to avoid the TS error
      // since we don't need the shipment_id in the returned data
